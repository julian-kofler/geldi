...
export const loginRequired = async (req: RequestWithUser, res: Response, next: NextFunction) => {
...
export function userIsDefined(req: RequestWithUser): req is RequestWithUser & { user: User } {
